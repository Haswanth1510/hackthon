...
async def analyze_skin(
    ...
    if diagnosis.get("success") is False or ("error" in diagnosis and diagnosis.get("is_human_face") is not False):
        ...
        return SkinAnalysisResponse(
            ...
            message="🤖 AI is too busy — please try later. Showing what we detected so far using computer vision (lesion regions & face geometry). Full clinical scoring, routines, and style curation will be ready once the AI is available again.",
            overall_score=None,
            skin_type=None,
            undertone=None,
            age_estimate=None,
            ...
            summary="🤖 AI is too busy — please try later.",
